      ...
      <div class="col-md-2 left-bar">
        <div class="mtem-2 plem-1">
          ...
          <div class="mtem-1 option-menu option-select rounded-pill">
              <p id="showTeachers" class="white plem-3 option-text"><i class="fa fa-user"></i>导师选择</p>
          </div>
            ...
            <tbody>
              <c:forEach  var="element" items="${ teachers }">
                <tr>
                  ...
                  <td>${element.info}</td>
                <td>
                <a href="chooseTeacher?id=${element.id}"  onclick="return confirm('确定选择该老师?')"><img width="23px" src="/psds/img/plus.png" /></a>
              </c:forEach>
            </tbody>
          </table>
