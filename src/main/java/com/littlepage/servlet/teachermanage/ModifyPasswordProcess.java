...
@WebServlet(urlPatterns = "/manage/teacher/modifyPasswordProcess")
public class ModifyPasswordProcess extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        System.out.println("data:" + oldPassword + newPassword + repeatPassword);
        if(StringUtils.isEmpty(oldPassword) || StringUtils.isEmpty(newPassword) ||
            ...
            if(!Md5Util.getMD5Str(oldPassword).equals(student.getPasswd())) {
                ...
                boolean success = teacherService.update(student);
