      ...
      <div class="col-md-2 left-bar">
        <div class="mtem-2 plem-1">
          ...
          <div class="mtem-1 option-menu option-select rounded-pill">
              <p id="chooseManage" class="white plem-3 option-text"><i class="fa fa-building-o prem-1"></i>志愿管理</p>
          </div>
          <div class="mtem-1 option-menu rounded-pill">
      ...
      <div class="col-md-10">
        ...
        <div class="mtem-2">
          ...
          <table class="table text-center">
            ...
            <tbody>
            <c:forEach  var="element" items="${ notFinalTableView }">
                <tr>
                    <td class="hidden">${element.studentId}</td>
                    <td class="hidden">${element.teacherId}</td>
                    <td>${element.studentNum}</td>
                    <td>${element.studentName}</td>
                    <td>${element.teacherNum}</td>
                    <td>${element.teacherName}</td>
                    <td>
                        <a href="finalChoose?studentId=${element.studentId}&teacherId=${element.teacherId}"  onclick="return confirm('确定决定最终志愿?')"><img width="23px" src="/psds/img/plus.png" /></a>
                    </td>
                </tr>
            </c:forEach>
            </tbody>
            ...
            <table class="table text-center">
                ...
                <tbody>
                <c:forEach  var="element" items="${ alreadyFinalTableViews }">
                    <tr>
                        <td class="hidden">${element.studentId}</td>
                        <td class="hidden">${element.teacherId}</td>
                        <td>${element.studentNum}</td>
                        ...
                        <td>${element.teacherName}</td>
                        <td>
                            <a href="revFinalChoose?studentId=${element.studentId}&teacherId=${element.teacherId}"  onclick="return confirm('确定决定最终志愿?')"><img width="23px" src="/psds/img/minus.png" /></a>
                        </td>
                    </tr>
                </c:forEach>
                </tbody>
