          ...
          <table class="table text-center">
            ...
            <c:forEach  var="element" items="${ notFinalTableView }">
                <tr>
                    ...
                    <td>
                        <a href="finalChoose?studentId=${element.studentId}&teacherId=${element.teacherId}"  onclick="return confirm('确定决定最终志愿?')"><img width="23px" src="../../img/plus.png" /></a>
                    </td>
                </tr>
            </c:forEach>
            </tbody>
            ...
            <table class="table text-center">
                ...
                <c:forEach  var="element" items="${ alreadyFinalTableViews }">
                    <tr>
                        ...
                        <td>${element.teacherName}</td>
                        <td>
                            <a href="revFinalChoose?studentId=${element.studentId}&teacherId=${element.teacherId}"  onclick="return confirm('确定决定最终志愿?')"><img width="23px" src="../../img/minus.png" /></a>
                        </td>
                    </tr>
                </c:forEach>
                </tbody>
